...
public final class Configuration {
	 ...
	 */
	public static String server_address = "99.3.65.127"; // Put ip here           99.3.65.127
	/**
	...
	public static final String LOCAL_CACHE_DIRECTORY = "./Cache/";//System.getProperty("user.home") + File.separator + "Augurypkz"+CLIENT_VERSION+"/";

	public static final String CACHE_DIRECTORY = System.getProperty("user.home") + File.separator + "Augurypkz"+CLIENT_VERSION+"/";
	 ...
	 */
	public static final String CLIENT_NAME = "Augury-Pkz";
