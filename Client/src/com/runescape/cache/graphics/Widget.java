...
public final class Widget {
	...
	public static void pvpTab(GameFont[] tda) {
		...
		addText(32026, "@or1@Achievements", tda, 2, 0xFFFFFF, false, true);
	...
	public static void ancientSpellbookEdit(GameFont[] t) {
		...
		//ADD "HOME" AND "OTHER" TELEPORTS ROW 1
		setBounds(39101, 25, 9, 0, tab);
		setBounds(12939, 65, 9, 1, tab);
		setBounds(12987, 105, 9, 2, tab);
		setBounds(13035, 156, 9, 3, tab);

		//Row 2
		setBounds(12901, 25, 50, 4, tab);
		setBounds(12861, 65, 50, 5, tab);
		setBounds(13045, 105, 50, 6, tab);
		setBounds(12963, 145, 50, 7, tab);

		//Row 3
		setBounds(13011, 25, 90, 8, tab);
		setBounds(13053, 65, 90, 9, tab);
		setBounds(12919, 105, 90, 10, tab);
		setBounds(12881, 145, 90, 11, tab);

		//Row 4
		setBounds(12911, 25, 130, 12, tab);
		setBounds(12871, 65, 130, 13, tab);
		setBounds(12999, 105, 130, 14, tab);
		setBounds(13069, 145, 130, 15, tab);

		//Row 5
		setBounds(13079, 25, 170, 16, tab);
		setBounds(12975, 65, 170, 17, tab);
	...
	public static void monsters(GameFont[] t) {
		...
		String[] tooltips = {"Teleport: Vespula", "Teleport: Pack Yaks", "Teleport: Experiments", "Teleport: Zombies", "Teleport: Bandits", "Teleport: Vespula", "Teleport: Vespula", "Teleport: Vespula", "Teleport: Vespula"};
	...
	public static void spinTab(GameFont[] wid) {
		...
		addHoverText(13011, "<u>Buy more spins", "Go to website", wid, 0, 0xff9040, true, false, 75, 0xFFB885);
		addSprite(13101, 541);
		addSprite(13012, 544);
