...
public class Locations {
	...
	public enum Location {
		WILDERNESS(new int[]{2940, 3392, 2986, 3012, 3653, 3720, 3650, 3653, 3150, 3199, 2994, 3041, 3466, 3504, 3490, 3507}, new int[]{3525, 3968, 10338, 10366, 3441, 3538, 3457, 3472, 3796, 3869, 3733, 3790, 3454, 3523, 3454, 3457}, false, true, true, true, true, true) {
			@Override
		...
		public static boolean inMulti(Character gc) {
			if(gc.getLocation() == WILDERNESS) {
				...
				if(x >= 3155 && y >= 3798 || x >= 3020 && x <= 3055 && y >= 3684 && y <= 3711 || x >= 3150 && x <= 3195 && y >= 2958 && y <= 3003 || x >= 3645 && x <= 3715 && y >= 3454 && y <= 3550 || x>= 3150 && x <= 3199 && y >= 3796 && y <= 3869 || x >= 2994 && x <= 3041 && y >= 3733 && y <= 3790 || x >= 3027 && x <= 3070 && y >= 3786 && y <= 3828 || x >= 3027 && x <= 3070 && y >= 3820 && y <= 3784)
					return true;
			}
