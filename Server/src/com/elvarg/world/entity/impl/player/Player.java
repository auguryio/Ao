...
public class Player extends Character {
	...
	public void onLogin() {
		...
		//Packets
		getPacketSender().sendMessage("Welcome to Augury-Pkz Beta v.01.");
		getPacketSender().sendMessage("If you happen to run into any bugs along the way PM a developer");
		...
		getPacketSender().sendString(15257, "Welcome to Augury-Pkz");
		getPacketSender().sendString(15258, "You're logged in from " + getHostAddress());
		getPacketSender().sendString(15259, "Your KDR Is Currently : @whi@ " +getKillDeathRatio()+"\\n Could be better!");
		getPacketSender().sendString(15260, "Message Any Staff Members for Information \\n regarding the server & \\n future updates");
		getPacketSender().sendString(15261, "@WHI@ANY FEEDBACK IS GOOD FEEDBACK!");
		getPacketSender().sendString(15270, "We Appreciate your support in our Beta Phases \\n Report any bugs to @whi@JPARKS");
		getPacketSender().sendString(15262, "You've Donated  @red@ $ " + getAmountDonated()+" \\n We appreciate your love and support");
